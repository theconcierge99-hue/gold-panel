...
**Solana on-chain mint (live):** see [rwa-solana-setup.md](rwa-solana-setup.md) — `RWA_MINT_SOL_SECRET`, optional `RWA_SIGNAL_CONTRACT_SOL` (collection not required; avoid dead links like truffle.wtf).
