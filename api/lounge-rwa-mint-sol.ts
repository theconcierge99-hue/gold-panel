...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const { getSignalById } = await import("../backend/concierge-api/signal-store");
    ...
    const { mintSolanaSignalNftForSignal } = await import("../backend/concierge-api/rwa-solana-mint");
