...
import { authorizeInternalApi } from "../backend/concierge-api/lounge-internal-auth";
import type { CreatorPayoutResult } from "../backend/concierge-api/creator-payout-types";
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const { disburseCreatorInstantShare } = await import("../backend/concierge-api/creator-instant-payout");
